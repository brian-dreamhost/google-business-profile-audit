        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
          ...
          {benchmark && (
            <div className={`mt-1 flex items-center gap-1.5 text-xs ${
              value >= benchmark.top ? 'text-turtle' : value >= benchmark.median ? 'text-tangerine' : 'text-prince'
            }`}>
              ...
              {value > 0 && value < benchmark.median && (
                <span className="text-coral font-medium ml-1">
                  (below average)
                </span>
              )}
              {value >= benchmark.median && value < benchmark.top && (
                <span className="text-tangerine font-medium ml-1">
                  (on par)
                </span>
              )}
              {value >= benchmark.top && (
                <span className="text-turtle font-medium ml-1">
                  (top performer!)
                </span>
              )}
            </div>
